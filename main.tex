...
%% @FilePath         : /Sudathesis-Bachelor-Template/main.tex
%% @LastTime         : 2023-01-10 11:05:21
...
\documentclass[degree=bachelor,fonset=windows,print-style=oneside]{sudathesis}
  % 学位 degree:
...
%\newfontfamily\zititime{Times New Roman}
...
% 插入独创性声明和使用授权说明
\frontmatter
%\let \cleardoublepage \clearpage % 强制去除每一章之间存在的空白页
\input{data/abstract}
...
% 参考文献
\bibliography{reference/refs}  % 参考文献使用 BibTeX 编译
