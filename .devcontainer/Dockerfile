...
RUN apt-get update && export DEBIAN_FRONTEND=noninteractive \
    && apt-get -y install --no-install-recommends texlive-xetex texlive-science texlive-lang-chinese texlive-lang-english texlive-bibtex-extra texlive-fonts-extra texlive-latex-extra biber chktex latexmk ttf-mscorefonts-installer\
